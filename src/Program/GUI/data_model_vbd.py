...
class DataModelVbd(DataModel):
    ...
    def initialization(self):
        ...
        self.max_value['ГПН'] = DataValue(str(10000))
    ...
    def save_overal_results(self, path):
        if self.joint_venture:
            ...
            j = 0
        self.__solution.export_overal_results(path=path, solution_index=j, month=self.__constraints.months[self.index], vbd = True)
